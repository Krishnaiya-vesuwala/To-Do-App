...
const AddEditNotes = ({ noteData, onClose, type, getAllNotes,showToastMessage }) => {

    // add content intialization
    ...
    return (
        <div className='relative'>
            ...
            <button className="bg-blue-500 font-medium mt-5 p-3 w-full cursor-pointer" onClick={handleAddNote}>
